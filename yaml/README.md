...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/bingoohuang/ngg/yaml)](https://pkg.go.dev/github.com/bingoohuang/ngg/yaml)
![Go](https://github.com/bingoohuang/ngg/yaml/workflows/Go/badge.svg)
[![codecov](https://codecov.io/gh/goccy/go-yaml/branch/master/graph/badge.svg)](https://codecov.io/gh/goccy/go-yaml)
[![Go Report Card](https://goreportcard.com/badge/github.com/bingoohuang/ngg/yaml)](https://goreportcard.com/report/github.com/bingoohuang/ngg/yaml)
...
```sh
go get -u github.com/bingoohuang/ngg/yaml
```
...
```sh
go install github.com/bingoohuang/ngg/yaml/cmd/ycat@latest
```
