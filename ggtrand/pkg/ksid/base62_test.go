...
func BenchmarkAppendEncodeBase62(b *testing.B) {
	...
	for i := 0; i != b.N; i++ {
		appendEncodeBase62(a[:0], id.Data[:])
	}
}
...
func BenchmarkAppendFastEncodeBase62(b *testing.B) {
	...
	for i := 0; i != b.N; i++ {
		fastAppendEncodeBase62(a[:0], id.Data[:])
	}
}
