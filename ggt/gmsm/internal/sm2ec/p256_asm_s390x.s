...
TEXT sm2P256MulInternalEmmansun<>(SB), NOSPLIT, $0-0
	// ---------------------------------------------------
...
TEXT sm2P256SqrInternalEmmansun<>(SB), NOFRAME|NOSPLIT, $0
	VLR X0, Y0
	VLR X1, Y1
	BR  sm2P256MulInternalEmmansun<>(SB)
