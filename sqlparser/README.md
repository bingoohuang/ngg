...
The backbone of this repo is extracted from

- [acra sqlparser](https://github.com/cossacklabs/acra/tree/master/sqlparser)
...
See [parse_test.go](https://github.com/bingoohuang/ngg/sqlparser/blob/master/parse_test.go) for more examples, or read the [godoc](https://godoc.org/github.com/bingoohuang/ngg/sqlparser).
...
XWB1989=${GOPATH?}/src/github.com/bingoohuang/ngg/sqlparser/
...
# Fix imports
sed -i '.bak' 's_vitess.io/vitess/go/vt/proto/query_github.com/bingoohuang/ngg/sqlparser/dependency/querypb_g' *.go dependency/sqltypes/*.go
sed -i '.bak' 's_vitess.io/vitess/go/_github.com/bingoohuang/ngg/sqlparser/dependency/_g' *.go dependency/sqltypes/*.go
