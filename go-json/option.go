...
import (
	...
	"github.com/bingoohuang/ngg/go-json/internal/decoder"
...
// NamingStrategy sets the naming strategy for the field.
func NamingStrategy(strategy api.NamingStrategy) EncodeOptionFunc {
	return func(opt *EncodeOption) {
		opt.NamingStrategy = strategy
	}
}
