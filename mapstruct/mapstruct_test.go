...
type Remainder struct {
	A     string
	Extra map[string]any `mapstruct:",remain"`
}
...
type StructWithOmitEmpty struct {
	...
	VisibleSliceField  []any          `mapstruct:"visible-slice"`
	OmitSliceField     []any          `mapstruct:"omittable-slice,omitempty"`
	VisibleMapField    map[string]any `mapstruct:"visible-map"`
	OmitMapField       map[string]any `mapstruct:"omittable-map,omitempty"`
...
func TestDecodeTable(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			&struct {
				VisibleField any `mapstruct:"visible"`
				OmitField    any `mapstruct:"omittable,omitempty"`
			}{
				VisibleField: nil,
				OmitField:    "string",
			},
