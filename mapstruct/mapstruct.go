...
func (d *Decoder) decodeTime(name string, data any, val reflect.Value) (dealt bool, err error) {
...
func (d *Decoder) decodePtr(name string, data any, outVal reflect.Value) (bool, error) {
